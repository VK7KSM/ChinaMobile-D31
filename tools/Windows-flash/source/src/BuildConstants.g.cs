namespace D31FlashTool
{
    ...
    {
        internal const string ToolVersion = "1.6.7";
        internal const string OfficialPackageName = "D31_SVP3390_Factory_Flash_v1.4.4_testkey.zip";
        internal const string OfficialGitHubUrl = "https://github.com/VK7KSM/ChinaMobile-D31/releases/download/v1.4.4/D31_SVP3390_Factory_Flash_v1.4.4_testkey.zip";
        internal const string OfficialCloudflareUrl = "https://cdn.elfradio.net/d31/D31_SVP3390_Factory_Flash_v1.4.4_testkey.zip";
        internal const string OfficialPackageSha256 = "22427BB1171CA778BFE51F3C9B2E1AD6916EF630DA08FF22B1DA4D41D90C9F58";
        internal const long OfficialPackageBytes = 1725684619L;
        ...
        {
            new RuntimeAssetDescriptor("approved-package.json", "D31FlashTool.Runtime.Asset00", "E3B2F6A55320AEB7A6D81B8BB9B6ACF7C4342E18BD60B1CF823A58A09E4F49A7"),
            new RuntimeAssetDescriptor("installed-files.json", "D31FlashTool.Runtime.Asset01", "03EBEB49EE2A636BA12222AB54BB86D61A0E1F024C6DC5DE9A4389B314382ADC"),
            ...
            new RuntimeAssetDescriptor("首次引导工具\\D31-basic-v1.34.6-candidate-basic-169.apk", "D31FlashTool.Runtime.BasicProbe169", "352D3143B4F18857CDAB08FFDABCE8D96F87A12865FC8DB70B0E333A82E07816"),
