...
if (-not $FirmwarePackage) { $FirmwarePackage = Join-Path $projectRoot '..\d31\dist\factory-flash-v1.4.3\D31_SVP3390_Factory_Flash_v1.4.3_testkey.zip' }
