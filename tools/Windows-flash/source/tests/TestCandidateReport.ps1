...
$approved=[IO.File]::ReadAllText($approvedPath) | ConvertFrom-Json
$firmwareContract=[pscustomobject]@{
    GitHubUrl=('https://github.com/VK7KSM/ChinaMobile-D31/releases/download/v'+$approved.version+'/'+$approved.fileName)
    CloudflareUrl=('https://cdn.elfradio.net/d31/'+$approved.fileName)
}
