...
try {
    ...
    foreach($name in @('repair-late','health-invalid','full96-no-protocol','full96-bad-path','full96-reserve-failed','full96-reserve-unknown',
        'full170-no-health','full170-old-health','full170-pm-no-health','legacy-evidence-unreadable','legacy-pm-unknown','legacy-active-present','legacy-version-mismatch',
