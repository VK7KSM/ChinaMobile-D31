...
$inputs += Join-Path $tests 'DiagnosticConfigurationCoverageTest.java'
...
& "$JavaHome/bin/java.exe" -Xmx512m -cp "$classes;$cp" org.junit.runner.JUnitCore net.elfradio.d31bootstrap.diagnostics.DiagnosticCoverageComparisonTest net.elfradio.d31bootstrap.diagnostics.DiagnosticComparatorTest net.elfradio.d31bootstrap.diagnostics.DiagnosticConfigurationCoverageTest 2>&1 | Tee-Object -FilePath "$output/junit.txt"
