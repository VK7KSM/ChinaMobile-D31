...
此目录保存1.4.2安装器、首次初始化、启动交接、载荷来源清单及离线验证代码；原始固件、私人日志、用户数据和签名私钥不在源码目录内。
...
- `source/sources-v1.4.2.json`：实际打包载荷的长度及SHA-256；最终ZIP和母机对照结果见[逐项复核](../../docs/D31-v1.4.2逐项复核.md)。
