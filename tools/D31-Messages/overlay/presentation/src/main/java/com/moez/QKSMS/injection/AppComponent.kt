...
interface AppComponent {
    ...
    fun messageRepository(): dev.octoshrimpy.quik.repository.MessageRepository
    fun conversationRepository(): dev.octoshrimpy.quik.repository.ConversationRepository
    fun notificationManager(): dev.octoshrimpy.quik.manager.NotificationManager
